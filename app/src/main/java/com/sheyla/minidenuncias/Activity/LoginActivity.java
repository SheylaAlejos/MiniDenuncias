...
import static com.sheyla.minidenuncias.ApiServiceGenerate.createService;
...
public class LoginActivity extends AppCompatActivity {
    ...
    public void showRegister(View view) {
        startActivityForResult(new Intent(this, RegisterUsuarioActivity.class), REGISTER_FORM_REQUEST);
    }
    public void Vecino( ) {
        startActivityForResult(new Intent(this, RegisterUsuarioActivity.class), REGISTER_FORM_REQUEST);
    }
